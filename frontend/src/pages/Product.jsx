        ...
        <div className="border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100">
            ...
            <div className="flex gap-12 sm:gap-12 flex-col sm:flex-row">
                ...
                <div className="flex-1">
                    ...
                    <button className="uppercase cursor-pointer hover:scale-105 transition-all duration-500 bg-black text-white px-8 py-3 text-sm active:bg-gray-700">Add to card</button>
