...
const Cart = () => {
  ...
  const isLoggedIn = localStorage.getItem('token'); // Adjust if your token key is different
                ...
                return (
                  <div key={index} className='py-4 border-t border-b text-gray-700 grid grid-cols-[4fr_0.5fr_0.5fr] sm:grid-cols-[4fr_2fr_0.5fr] items-center gap-4'>
                    <div className='flex items-start gap-6'>
                      <img src={productData.image[0]} alt='' className='w-full max-w-[100px] sm:max-w-[100px] sm:h-full object-cover object-top-right max-h-[100px]' />
                      <div>
                        <p className='text-xs sm:text-lg font-medium'>{productData.name}</p>
                        <div className='flex md:flex-row flex-col md:item-center items-start gap-3 mt-2 '>
                          <p> {currency}
